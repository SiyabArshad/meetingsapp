import { View, SafeAreaView,Text,TouchableOpacity,Pressable,Button,Modal,ImageBackground,Platform,Dimensions,Image,ScrollView ,StyleSheet,TextInput} from 'react-native'
...
export default function Appointment({navigation}) {
  ...
  return (
    ...
    <View style={{display:"flex",alignItems:"center",justifyContent:"center",position:"absolute",width:wi
    ,bottom:1,zIndex:9999
}}>
